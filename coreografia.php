        ...
        <div class="container">
            <nav class="navbar navbar-nav-scroll menu fixed-top ">
                <div class="container-fluid ">
                    <a class="navbar-brand" style="color: rgb(255, 255, 255);" href="index.php"><img
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-header" style="background-color: black;">
                            <a class="  navbar-brand" style="color: rgb(255, 255, 255);" href="#"><img
                                    style="width: 170px;" src="/leitor/img/logo-menu.png" alt=""></a>
                        ...
                        <div class="offcanvas-body ">
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link" onclick="ativarTabela()" href="#" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal">Tabela de Precos</a>
                            ...
                            <div class="carrinho-compras">
                                <ul id="carrinho">
                                    ...
                                    <!-- <div class="teste_carrinho">
                                        <img src="COREOGRAFIAS/COREOGRAFIA 1/IMG_1996.JPG" alt="">
                                        <P>teste</P>
                                    </div> -->
                                </ul>
                            </div>
            ...
            <div class="container form_pedido">
                ...
                <div class="mb-2 mt-2">
                    <button type="submit" class="btn btn-warning"
                        onclick="finalizarCompra(event, <?php echo $num_coreografia ?>)">Enviar
                        Pedido</button>
                </div>
